...
public class EndMissionMenu {
	...
	public EndMissionMenu(BaseGameActivity activity,final Scene scene,String goalText,String leftHospitalText,String ambulanceText,String treatedText,String fundsText,boolean isPass){
		...
		if(!isPass){
			TiledTextureRegion retryButtonTextureRegion = layoutBitmapTextureAtlas3.appendTiledAsset(activity, "daminibuttons.png", 3, 1);  
		   ...
		   retryButton.setPosition(endMissionBorder.getWidth()/4-retryButton.getWidth()/2, endMissionBorder.getHeight()-retryButton.getHeight()*3/2);
			...
			TiledTextureRegion nextButtonTextureRegion = layoutBitmapTextureAtlas3.appendTiledAsset(activity, "daminibuttons.png", 3, 1);  
		   ...
		   nextMissionButton.setCurrentTileIndex(0);
		   nextMissionButton.setPosition(endMissionBorder.getWidth()/4-retryButton.getWidth()/2, endMissionBorder.getHeight()-nextMissionButton.getHeight()*3/2);
		...
		TiledTextureRegion mainMenuButtonTextureRegion = layoutBitmapTextureAtlas4.appendTiledAsset(activity, "daminibuttons.png", 3, 1);  
		mainMenuButton = new TextButton(0,0, mainMenuButtonTextureRegion,lcdFont,"Next"){
			@Override
			public boolean onAreaTouched(final TouchEvent pSceneTouchEvent, final float pTouchAreaLocalX, final float pTouchAreaLocalY) {
				int myEventAction = pSceneTouchEvent.getAction(); 
		        switch (myEventAction) {
	   ...
	   mainMenuButton.setCurrentTileIndex(0);
	   mainMenuButton.setPosition(endMissionBorder.getWidth()*3/4-retryButton.getWidth()/2, endMissionBorder.getHeight()-mainMenuButton.getHeight()*3/2);
